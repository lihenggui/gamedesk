...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(check_ws("127.0.0.1:20115"), "ws://127.0.0.1:20118");
        assert_eq!(check_ws("127.0.0.1:20116"), "ws://127.0.0.1:20118");
        assert_eq!(check_ws("127.0.0.1:20117"), "ws://127.0.0.1:20119");
        assert_eq!(check_ws("rustdesk.com:20115"), "ws://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:20116"), "ws://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:20117"), "ws://rustdesk.com/ws/relay");
        ...
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:20115"),
            "ws://[0:0:0:0:0:0:0:1]:20118"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:20116"),
            "ws://[0:0:0:0:0:0:0:1]:20118"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:20117"),
            "ws://[0:0:0:0:0:0:0:1]:20119"
        );
        assert_eq!(check_ws("rustdesk.com:20115"), "wss://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:20116"), "wss://rustdesk.com/ws/id");
        assert_eq!(
            check_ws("rustdesk.com:20117"),
            "wss://rustdesk.com/ws/relay"
        );
        // set relay-server with default port
        Config::set_option("relay-server".to_string(), "127.0.0.1:20117".to_string());
        assert_eq!(check_ws("127.0.0.1:20115"), "ws://127.0.0.1:20118");
        assert_eq!(check_ws("127.0.0.1:20116"), "ws://127.0.0.1:20118");
        assert_eq!(check_ws("127.0.0.1:20117"), "ws://127.0.0.1:20119");
