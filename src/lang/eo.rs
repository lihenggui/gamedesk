...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Konektante al la reto GameDesk..."),
        ...
        ("install_tip", "Vi ne uzas instalita versio. Pro limigoj pro UAC, kiel aparato kontrolata, en kelkaj kazoj, ne estos ebla kontroli la muson kaj klavaron aŭ registri la ekranon. Bonvolu alkliku la butonon malsupre por instali GameDesk sur la operaciumo por eviti la demando supre."),
        ("Click to upgrade", "Alklaki por plibonigi"),
        ("Configure", "Konfiguri"),
        ("config_acc", "Por uzi vian foran aparaton, bonvolu doni la permeson \"alirebleco\" al GameDesk."),
        ("config_screen", "Por uzi vian foran aparaton, bonvolu doni la permeson \"ekranregistrado\" al GameDesk."),
        ...
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso aŭ tuŝo, vi devas permesi al GameDesk uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva paĝo de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], ŝalti la servon [GameDesk Enigo]."),
        ...
        ("Language", "Lingvo"),
        ("Keep GameDesk background service", "Tenu GameDesk fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas malŝalti ĉi tiun funkcion, bonvolu iri al la sekva paĝo de agordoj de la aplikaĵo de GameDesk, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
        ...
        ("config_input", "Por kontroli la foran labortablon per klavaro, vi devas doni al GameDesk permeson \"Eniga Monitorado\"."),
        ("config_microphone", "Por paroli fore, vi devas doni al GameDesk permeson \"Registri Sonon\"."),
        ...
        ("still_click_uac_tip", "Ankoraŭ postulas ke la fora uzanto alklaku Bone en la UAC-fenestro de la funkcianta GameDesk."),
        ...
        ("verify_rustdesk_password_tip", "Kontroli GameDesk-pasvorton"),
        ...
        ("scam_text1", "Se vi telefonas kun iu kiun vi NE konas KAJ FIDAS, kiu petis vin uzi GameDesk kaj komenci la servon, ne daŭrigu kaj tuj malŝaltu la telefonon."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bonvolu ĝisdatigi GameDesk Server Pro al versio {} aŭ pli nova!"),
        ...
        ("selinux_tip", "SELinux estas ebligita sur via aparato, kio povas malhelpi GameDesk funkcii ĝuste kiel kontrolata flanko."),
        ...
        ("powered_by_me", "Funkciigita de GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permesi konekton nur se la fenestro de GameDesk estas malfermita"),
        ...
        ("floating_window_tip", "Ĝi helpas teni la fonan servon de GameDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Bonvolu ĝisdatigi la GameDesk-klienton al versio {} aŭ pli nova ĉe la fora flanko!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Implicite, GameDesk kontrolas la servilan atestilon por protokoloj uzantaj TLS.\nKun ĉi tiu opcio ebligita, GameDesk retrokadros al preterlaso de la kontrola paŝo kaj daŭrigos en kazo de kontrola malsukceso."),
        ("Disable UDP", "Malebligi UDP"),
        ("disable-udp-tip", "Regas ĉu uzi nur TCP.\nKiam ĉi tiu opcio estas ebligita, GameDesk ne plu uzos UDP 20116, TCP 20116 estos uzata anstataŭe."),
        ("server-oss-not-support-tip", "NOTU: GameDesk-servilo OSS ne inkluzivas ĉi tiun funkcion."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk ne povas atingi la labortablan seancon sur la fora aparato, kontrolu ke seanco funkcias kaj ke GameDesk povas uzi ĝin"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk ne povis akiri uzeblan ekranon de XDG Desktop Portal, la biblioteko PipeWire eble estas tro malnova"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk ne povis ŝargi komponanton de GStreamer necesan por ekrankapto ({})"),
