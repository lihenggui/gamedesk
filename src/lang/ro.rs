...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua GameDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca GameDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala GameDesk."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți GameDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți GameDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți GameDesk să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [GameDesk Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep GameDesk background service", "Rulează serviciul GameDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației GameDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show GameDesk", "Afișează GameDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi GameDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi GameDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din GameDesk care rulează."),
        ...
        ("verify_rustdesk_password_tip", "Verifică parola GameDesk"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi GameDesk pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Versiunea serverului GameDesk Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul GameDesk pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu GameDesk"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web GameDesk Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări GameDesk. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About GameDesk", "Despre GameDesk"),
        ...
        ("web_id_input_tip", "Introdu ID-ul GameDesk al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Versiunea clientului GameDesk de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește GameDesk Pro pentru funcționalitate completă."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk nu poate accesa sesiunea de desktop de pe dispozitivul de la distanță, verificați dacă o sesiune rulează și dacă GameDesk o poate folosi"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk nu a putut obține un ecran utilizabil de la XDG Desktop Portal, biblioteca PipeWire poate fi prea veche"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk nu a putut încărca o componentă GStreamer necesară pentru capturarea ecranului ({})"),
