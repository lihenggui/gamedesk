...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "กำลังเชื่อมต่อไปยังเครือข่าย GameDesk..."),
        ...
        ("install_tip", "เนื่องด้วยข้อจำกัดของการใช้งาน UAC ทำให้ GameDesk ไม่สามารถทำงานได้ปกติในฝั่งปลายทางในบางครั้ง เพื่อหลีกเลี่ยงข้อจำกัดของ UAC กรุณากดปุ่มด้านล่างเพื่อติดตั้ง GameDesk ไปยังระบบของคุณ"),
        ("Click to upgrade", "คลิกเพื่ออัปเกรด"),
        ("Configure", "ปรับแต่งค่า"),
        ("config_acc", "เพื่อที่จะควบคุมเดสก์ท็อปปลายทางของคุณ คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การเข้าถึง\" ให้แก่ GameDesk"),
        ("config_screen", "เพื่อที่จะควบคุมเดสก์ท็อปปลายทางของคุณ คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การบันทึกภาพหน้าจอ\" ให้แก่ GameDesk"),
        ...
        ("android_input_permission_tip1", "ในการที่จะอนุญาตให้เครื่องปลายทางควบคุมอุปกรณ์แอนดรอยด์ของคุณโดยใช้เมาส์หรือการสัมผัส คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การเข้าถึง\" ให้แก่เซอร์วิสของ GameDesk"),
        ("android_input_permission_tip2", "กรุณาไปยังหน้าตั้งค่าถัดไป ค้นหาและเข้าไปยัง [เซอร์วิสที่ถูกติดตั้ง] และเปิดการใช้งานเซอร์วิส [อินพุท GameDesk]"),
        ...
        ("Turned off", "ปิด"),
        ("Language", "ภาษา"),
        ("Keep GameDesk background service", "คงสถานะการทำงานเบื้องหลังของเซอร์วิส GameDesk"),
        ("Ignore Battery Optimizations", "เพิกเฉยการตั้งค่าการใช้งาน Battery Optimization"),
        ("android_open_battery_optimizations_tip", "หากคุณต้องการปิดการใช้งานฟีเจอร์นี้ กรุณาไปยังหน้าตั้งค่าในแอปพลิเคชัน GameDesk ค้นหาหัวข้อ [Battery] และยกเลิกการเลือกรายการ [Unrestricted]"),
        ...
        ("config_input", "เพื่อที่จะควบคุมเครื่องเดสก์ท็อปปลายทางด้วยคีย์บอร์ด คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การตรวจสอบ Input\" ให้แก่ GameDesk"),
        ("config_microphone", "เพื่อที่จะส่งเสียงพูดไปยังปลายทาง คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การบันทึกเสียง\" ให้แก่ GameDesk"),
        ...
        ("still_click_uac_tip", "ผู้ใช้งานปลายทางยังจำเป็นที่จะต้องกดปุ่ม ตกลง บนหน้าต่าง UAC ของ GameDesk"),
        ...
        ("View Mode", "โหมดการดู"),
        ("verify_rustdesk_password_tip", "ยืนยันความถูกต้องรหัสผ่านของ GameDesk"),
        ...
        ("scam_text1", "ถ้าคุณกำลังคุยโทรศัพท์กับคนที่คุณไม่รู้จักและไม่ไว้ใจ และคนๆนั้นกำลังขอให้คุณเปิดใช้งาน GameDesk อย่าทำตามและรีบวางสายในทันที"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "กรุณาอัปเดต GameDesk Server Pro ไปยังเวอร์ชัน {} หรือใหม่กว่า!"),
        ...
        ("selinux_tip", "SELinux ถูกเปิดใช้งานบนอุปกรณ์ของคุณ ซึ่งอาจทำให้ GameDesk ทำงานเป็นฝ่ายถูกควบคุมได้ไม่สมบูรณ์"),
        ...
        ("powered_by_me", "ขับเคลื่อนโดย GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "อนุญาตการเชื่อมต่อเฉพาะเมื่อหน้าต่าง GameDesk เปิดอยู่"),
        ...
        ("floating_window_tip", "ช่วยให้บริการเบื้องหลังของ GameDesk ทำงานต่อเนื่อง"),
        ...
        ("About GameDesk", "เกี่ยวกับ GameDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "กรุณาอัปเดต GameDesk ไคลเอนต์ไปยังเวอร์ชัน {} หรือใหม่กว่าที่ฝั่งปลายทาง!"),
        ...
        ("allow-insecure-tls-fallback-tip", "โดยค่าเริ่มต้น GameDesk จะตรวจสอบใบรับรองของเซิร์ฟเวอร์สำหรับโปรโตคอลที่ใช้ TLS\nเมื่อเปิดใช้งานตัวเลือกนี้ GameDesk จะย้อนกลับไปข้ามขั้นตอนการตรวจสอบและดำเนินการต่อในกรณีที่การตรวจสอบล้มเหลว"),
        ("Disable UDP", "ปิดใช้งาน UDP"),
        ("disable-udp-tip", "ควบคุมว่าจะใช้ TCP เท่านั้นหรือไม่\nเมื่อเปิดใช้งานตัวเลือกนี้ GameDesk จะไม่ใช้ UDP 20116 อีกต่อไป และจะใช้ TCP 20116 แทน"),
        ("server-oss-not-support-tip", "หมายเหตุ: GameDesk server OSS ไม่มีคุณสมบัตินี้"),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk ไม่สามารถเข้าถึงเซสชันเดสก์ท็อปบนอุปกรณ์ระยะไกล ตรวจสอบว่าเซสชันเดสก์ท็อปกำลังทำงานและ GameDesk ใช้งานได้"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk ไม่สามารถรับหน้าจอที่ใช้งานได้จาก XDG Desktop Portal ไลบรารี PipeWire อาจเก่าเกินไป"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk ไม่สามารถโหลดส่วนประกอบ GStreamer ที่จำเป็นสำหรับการบันทึกหน้าจอได้ ({})"),
