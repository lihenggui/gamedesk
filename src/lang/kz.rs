...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Дайын"),
        ("Established", "Қосылды"),
        ("connecting_status", "GameDesk желісіне қосылуда..."),
        ...
        ("install_tip", "UAC кесірінен, GameDesk кейбірде қашықтағы жақ ретінде дұрыс жұмыс істей алмайды. UAC'пен қиындықты болдырмау үшін, төмендегі батырманы басып GameDesk'ті жүйеге орнатыңыз."),
        ("Click to upgrade", "Жаңғырту үшін басыңыз"),
        ("Configure", "Қалыптау"),
        ("config_acc", "Сіздің Жұмыс үстеліңізді қашықтан басқару үшін, GameDesk'ке \"Қолжетімділік\" рұқсаттарын беруіңіз керек."),
        ("config_screen", "Сіздің Жұмыс үстеліңізге қашықтан қол жеткізу үшін, GameDesk'ке \"Екіренді Жазу\" рұқсаттарын беруіңіз керек."),
        ("Installing ...", "Орнатылу..."),
        ("Install", "Орнату"),
        ...
        ("android_input_permission_tip1", "Қашықтағы құрылғы сіздің Android құрылғыңызды тінтуір немесе түрту арқылы басқару үшін, GameDesk'ке \"Қолжетімділік\" сербесін қолдануға рұқсат беруініз керек."),
        ("android_input_permission_tip2", "Келесі Жүйе Орнатпалары бетіне барып, [Орнатылған Сербестер]'ді тауып кіріңіз, сосын [GameDesk Еңгізу] сербесін іске қосыңыз."),
        ...
        ("Language", "Тіл"),
        ("Keep GameDesk background service", "Артжақтағы GameDesk сербесін сақтап тұру"),
        ("Ignore Battery Optimizations", "Бәтері Оңтайландыруларын Елемеу"),
        ("android_open_battery_optimizations_tip", "Егер де бұл ерекшелікті өшіруді қаласаңыз, келесі GameDesk апылқат орнатпалары бетіне барып, [Бәтері]'ні тауып кіріңіз де [Шектеусіз]'ден құсбелгіні алып тастауды өтінеміз"),
        ...
        ("Show GameDesk", "GameDesk'ті көрсету"),
        ("This PC", "Бұл ДК"),
        ("or", "немесе"),
        ...
        ("config_input", "Қашықтағы жұмыс үстелін пернетақтамен басқару үшін, GameDesk'ке \"Еңгізуді Қадағалау\" рұқсаттарын беруіңіз керек."),
        ("config_microphone", "Қашықтан сөйлесу үшін, GameDesk'ке \"Аудио Жазу\" рұқсаттарын беруіңіз керек."),
        ...
        ("still_click_uac_tip", "Қашықтағы қолданушыдан GameDesk іске қосылған UAC терезесінде OK басуды әлі де талап етеді."),
        ...
        ("verify_rustdesk_password_tip", "GameDesk құпия сөзін тексеру"),
        ...
        ("scam_text1", "Егер сіз танымайтын ЖӘНЕ СЕНБЕЙТІН біреумен телефонмен сөйлесіп жатсаңыз және ол сізден GameDesk қолданып, сербесті іске қосуды сұраса, жалғастырмаңыз да дереу телефонды қойыңыз."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "GameDesk Server Pro'ны {} немесе одан жаңа нұсқаға жаңартуды өтінеміз!"),
        ...
        ("selinux_tip", "Сіздің құрылғыңызда SELinux қосылған, бұл GameDesk'тің басқарылатын жақ ретінде дұрыс жұмыс істеуіне кедергі келтіруі мүмкін."),
        ...
        ("powered_by_me", "GameDesk негізінде"),
        ...
        ("allow-only-conn-window-open-tip", "Тек GameDesk терезесі ашық болғанда ғана қосылымға рұқсат ету"),
        ...
        ("floating_window_tip", "Ол GameDesk артжақ сербесін сақтап тұруға көмектеседі"),
        ...
        ("About GameDesk", "GameDesk туралы"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Қашықтағы жақтағы GameDesk клиентін {} немесе одан жоғары нұсқаға жаңартуды өтінеміз!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Әдепкіде GameDesk TLS қолданатын протоколдар үшін сербер сертификатын тексереді.\nБұл опция қосылғанда, GameDesk тексеру сәтсіз болған жағдайда тексеру қадамын өткізіп жіберуге қайтып, жалғастырады."),
        ("Disable UDP", "UDP-ні өшіру"),
        ("disable-udp-tip", "Тек TCP қолданатынын-қолданбайтынын басқарады.\nБұл опция қосылғанда, GameDesk енді UDP 20116 қолданбайды, оның орнына TCP 20116 қолданылады."),
        ("server-oss-not-support-tip", "ЕСКЕРТПЕ: GameDesk server OSS бұл ерекшелікті қамтымайды."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk қашықтағы құрылғының жұмыс үстелі сеансына қол жеткізе алмайды, сеанстың іске қосылғанын және GameDesk оны пайдалана алатынын тексеріңіз"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk XDG Desktop Portal-дан жарамды экран ала алмады, PipeWire кітапханасы тым ескі болуы мүмкін"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk экранды түсіру үшін қажет GStreamer компонентін жүктей алмады ({})"),
