...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "GameDesk sarera konektatzen..."),
        ...
        ("install_tip", "Erabiltzaile Kontuen Kontrolarengatik, GameDesk ezin du ondo funtzionatu urruneko mahaigainean. EKK saihesteko, mesedez, egin klik azpiko botoian GameDesk sistema mailan instalatzeko."),
        ("Click to upgrade", "Egin klik bertsio-berritzeko"),
        ("Configure", "Konfiguratu"),
        ("config_acc", "Zure mahaigaina urrunetik kontrolatzeko, GameDesk-i \"Irisgarritasuna\" baimenak eman behar dituzu."),
        ("config_screen", "Zure mahaigaina kanpotik kontrolatzeko, GameDesk-i \"Pantaila grabatu\" baimena eman behar duzu."),
        ...
        ("android_input_permission_tip1", "Urruneko gailu batek zure Android gailua saguaren edo ukipenaren bidez kontrolatzeko, GameDesk \"Irisgarritasuna\" zerbitzua erabiltzeko baimena eman behar diozu."),
        ("android_input_permission_tip2", "Joan hurrengo irekiko den sistemaren konfigurazio orrira, bilatu eta sartu [Instalatutako zerbitzuak], aktibatu [GameDesk Input] zerbitzua."),
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep GameDesk background service", "Mantendu GameDesk atzeko planoko zerbitzu bezala"),
        ("Ignore Battery Optimizations", "Ezikusi bateria optimizazioak"),
        ("android_open_battery_optimizations_tip", "Ezaugarri hau desgaitu nahi baduzu, joan zaitez GameDesk aplikazioaren ezarpen orrira, bilatu eta saltu [Bateria] orrira eta kendu [Mugarik gabe]"),
        ...
        ("Show GameDesk", "Erakutsi GameDesk"),
        ("This PC", "PC hau"),
        ("or", "edo"),
        ("Elevate", "Igo maila"),
        ...
        ("config_input", "Urruneko mahaigaina teklatuaren bidez kontrolatzeko, GameDesk-i \"Sarrera monitorizazioa\" baimena eman behar diozu."),
        ("config_microphone", "Urrunetik hitz egin ahal izateko, GameDeski-i \"Grabatu audioa\" baimena eman behar diozu."),
        ...
        ("still_click_uac_tip", "Oraindik beharrezkoa da urruneko erabiltzaileak Ondo botoiari klik egitea exekutatzen ari den GameDesk UAC leihoan"),
        ...
        ("verify_rustdesk_password_tip", "Berretsi GameDesk pasahitza"),
        ...
        ("scam_text1", "Ezagutzen eta fidatzen EZ duzun norbaitekin telefonoz bazaude eta GameDesk erabiltzeko eta zerbitzua abiarazteko eskatu badizute, ez ezazu egin eta eskegi berehala."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Mesedez, bertsio-berritu GameDesk Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("selinux_tip", "SELinux zure gailuan gaituta dago. Honek GameDesk kontrolatutako alde gisa dagoenean behar bezala ez exekutatzea ekarri dezake."),
        ...
        ("powered_by_me", "GameDesk-ek egina"),
        ...
        ("allow-only-conn-window-open-tip", "Baimendu konexioa GameDesk leihoa irekita badago"),
        ...
        ("floating_window_tip", "GameDesk atzeko planoko zerbitzua mantentzen laguntzen du"),
        ...
        ("About GameDesk", "GameDesk-i buruz"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Mesedez, eguneratu GameDesk bezeroa {} bertsiora edo berriagoa urruneko aldean!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Modu lehenetsian, GameDesk-ek zerbitzariaren ziurtagiria egiaztatzen du TLS erabiltzen duten protokoloetarako.\nAukera hau gaituta dagoela, GameDesk-ek egiaztapen-urratsa saltatzera joko du eta aurrera egingo du egiaztapenak huts eginez gero."),
        ("Disable UDP", "Desgaitu UDP"),
        ("disable-udp-tip", "TCP soilik erabiliko den kontrolatzen du.\nAukera hau gaituta dagoenean, GameDesk-ek ez du gehiago UDP 20116 erabiliko; horren ordez, TCP 20116 erabiliko da."),
        ("server-oss-not-support-tip", "OHARRA: GameDesk zerbitzariaren OSS bertsioak ez du ezaugarri hau barne hartzen."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk-ek ezin du urruneko gailuko mahaigaineko saioa atzitu, egiaztatu saio bat martxan dagoela eta GameDesk-ek erabil dezakeela"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk-ek ezin izan du pantaila erabilgarririk lortu XDG Desktop Portal-etik, PipeWire liburutegia zaharregia izan daiteke"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk-ek ezin izan du pantaila kapturatzeko beharrezkoa den GStreamer osagai bat kargatu ({})"),
