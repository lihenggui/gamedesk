...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip1", "GameDesk இந்த Android சாதனத்தை கட்டுப்படுத்த \"அணுகல் சேவைகள்\" அனுமதி தேவை."),
        ("android_input_permission_tip2", "சிஸ்டம் அமைப்புகளில் [நிறுவப்பட்ட சேவைகள்] கண்டுபிடித்து, GameDesk சேவை இயக்கவும்."),
        ...
        ("Language", "மொழி"),
        ("Keep GameDesk background service", "GameDesk பின்புல சேவையை வைத்திரு"),
        ("Ignore Battery Optimizations", "பேட்டரி மேம்படுத்தல்களை புறக்கணி"),
        ("android_open_battery_optimizations_tip", "GameDesk க்கு பேட்டரி மேம்படுத்தல் அணைக்க அமைப்புகளுக்கு செல்லவும்"),
        ...
        ("Show GameDesk", "GameDesk ஐ காட்டு"),
        ("This PC", "இந்த PC"),
        ("or", "அல்லது"),
        ("Elevate", "உயர்த்து"),
        ...
        ("scam_text2", "GameDesk ஊழியர் இவ்வாறு தொடர்பு கொள்ள மாட்டார்கள்"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "GameDesk Server Pro {} க்கு மேம்படுத்து"),
        ...
        ("selinux_tip", "SELinux இயக்கப்பட்டது, GameDesk அனுமதி வேண்டும்"),
        ...
        ("enable-2fa-desc", "GameDesk இரு காரணி அங்கீகாரம் ஆதரிக்கிறது"),
        ...
        ("allow-insecure-tls-fallback-tip", "இயல்பாக, TLS ஐப் பயன்படுத்தும் நெறிமுறைகளுக்கு GameDesk சர்வர் சான்றிதழை சரிபார்க்கிறது.\nஇந்த விருப்பம் இயக்கப்பட்டால், சரிபார்ப்பு தோல்வியடைந்தால் GameDesk சரிபார்ப்பு படிநிலையைத் தவிர்த்து தொடரும்."),
        ("Disable UDP", "UDP ஐ முடக்கு"),
        ("disable-udp-tip", "TCP ஐ மட்டுமே பயன்படுத்த வேண்டுமா என்பதைக் கட்டுப்படுத்துகிறது.\nஇந்த விருப்பம் இயக்கப்பட்டால், GameDesk இனி UDP 20116 ஐப் பயன்படுத்தாது, அதற்குப் பதிலாக TCP 20116 பயன்படுத்தப்படும்."),
        ("server-oss-not-support-tip", "குறிப்பு: GameDesk சர்வர் OSS இந்த அம்சத்தை உள்ளடக்கவில்லை."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk தொலைநிலை சாதனத்தின் டெஸ்க்டாப் அமர்வை அணுக முடியவில்லை, ஒரு அமர்வு இயங்குகிறதா என்பதையும் GameDesk அதைப் பயன்படுத்த முடியுமா என்பதையும் சரிபார்க்கவும்"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "XDG Desktop Portal-லிருந்து பயன்படுத்தக்கூடிய திரையை GameDesk பெற முடியவில்லை, PipeWire நூலகம் மிகவும் பழையதாக இருக்கலாம்"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "திரைப் பதிவுக்குத் தேவையான GStreamer கூறை GameDesk ஏற்ற முடியவில்லை ({})"),
