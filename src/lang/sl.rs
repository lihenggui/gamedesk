...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem GameDesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, GameDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate GameDesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate GameDesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno GameDesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »GameDesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep GameDesk background service", "Ohrani GameDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije GameDesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "GameDesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "GameDesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za GameDesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite GameDesk, prekinite klic in program zaprite."),
        ("scam_text2", "GameDesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite GameDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno GameDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri GameDesk storitvi v ozadju"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite GameDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto GameDesk preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo GameDesk ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, GameDesk ne bo več uporabljal UDP 20116, namesto tega bo uporabljen TCP 20116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik GameDesk OSS ne vključuje te funkcije."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk ne more dostopati do namizne seje na oddaljeni napravi, preverite, ali seja teče in ali jo GameDesk lahko uporablja"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk od XDG Desktop Portala ni dobil uporabnega zaslona, knjižnica PipeWire je morda prestara"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk ni mogel naložiti komponente GStreamer, potrebne za zajem zaslona ({})"),
