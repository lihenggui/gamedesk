...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do GameDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o GameDesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o GameDesk no sistema."),
        ("Click to upgrade", "Iniciar atualização"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao GameDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao GameDesk permissões de \"Gravar a Tela\""),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o GameDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [GameDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep GameDesk background service", "Manter o serviço do GameDesk executando em segundo plano"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do GameDesk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do GameDesk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do GameDesk."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do GameDesk"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o GameDesk e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o GameDesk Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o GameDesk funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do GameDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço GameDesk em segundo plano"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente GameDesk para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o GameDesk verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o GameDesk ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o GameDesk não usará mais UDP 20116, TCP 20116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor GameDesk OSS não inclui este recurso."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "O GameDesk não consegue acessar a sessão da área de trabalho no dispositivo remoto, verifique se há uma sessão da área de trabalho em execução e se o GameDesk pode acessá-la."),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "O GameDesk não conseguiu obter uma tela utilizável do XDG Desktop Portal. A biblioteca do PipeWire pode estar desatualizada."),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "O GameDesk não conseguiu carregar um componente do GStreamer necessário para a captura de tela ({})."),
