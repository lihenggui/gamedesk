...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de GameDesk..."),
        ...
        ("install_tip", "En alguns casos és possible que el GameDesk no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el GameDesk al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al GameDesk els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al GameDesk els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al GameDesk l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «GameDesk Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep GameDesk background service", "Manté el servei del GameDesk en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del GameDesk, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("elevated_foreground_window_tip", "La finestra de connexió actual requereix permisos ampliats per a funcionar i, de forma temporal, no es pot utilitzar ni el teclat ni el ratolí. Demaneu a l'usuari remot que minimitzi la finestra actual, o bé que faci clic al botó Permisos ampliats de la finestra d'administració de la connexió. Per a evitar aquest problema en un futur, instal·leu el GameDesk al dispositiu remot."),
        ...
        ("Show GameDesk", "Mostra el GameDesk"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al GameDesk els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al GameDesk els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del GameDesk en execució."),
        ...
        ("verify_rustdesk_password_tip", "Verifica la contrasenya del GameDesk"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del GameDesk, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Actualitzeu el GameDesk Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el GameDesk funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del GameDesk està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del GameDesk en rerefons"),
        ...
        ("About GameDesk", "Quant al GameDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Actualitzeu el client GameDesk a la versió {} o superior a la part remota!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per defecte, el GameDesk verifica el certificat del servidor per als protocols que utilitzen TLS.\nAmb aquesta opció habilitada, el GameDesk ometrà el pas de verificació i continuarà en cas que aquesta falli."),
        ("Disable UDP", "Inhabilita l'UDP"),
        ("disable-udp-tip", "Controla si s'utilitza només TCP.\nAmb aquesta opció habilitada, el GameDesk ja no utilitzarà l'UDP 20116, sinó que utilitzarà el TCP 20116 en el seu lloc."),
        ("server-oss-not-support-tip", "NOTA: El GameDesk Server OSS no inclou aquesta característica."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "El GameDesk no pot accedir a la sessió d'escriptori del dispositiu remot; comproveu que hi ha una sessió en marxa i que el GameDesk hi pot accedir"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "El GameDesk no ha pogut obtenir cap pantalla utilitzable de l'XDG Desktop Portal; la biblioteca PipeWire pot ser massa antiga"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "El GameDesk no ha pogut carregar un component del GStreamer necessari per capturar la pantalla ({})"),
