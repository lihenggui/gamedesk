...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Gereed"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het GameDesk-netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer GameDesk op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u GameDesk toestemming geven voor Toegankelijkheid."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u GameDesk toestemming geven voor Schermopname."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u GameDesk toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [GameDesk Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep GameDesk background service", "GameDesk achtergronddienst behouden"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u GameDesk toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u GameDesk toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende GameDesk."),
        ...
        ("verify_rustdesk_password_tip", "Bevestiging wachtwoord GameDesk"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om GameDesk te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Upgrade GameDesk Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor GameDesk mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("powered_by_me", "Werkt met GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het GameDesk-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt GameDesk op de achtergrond actief te houden"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Upgrade de GameDesk client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert GameDesk het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat GameDesk verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt GameDesk niet langer UDP 20116, maar TCP 20116."),
        ("server-oss-not-support-tip", "Opmerking: Deze functie is niet beschikbaar in de open-sourceversie van de GameDesk-server."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk heeft geen toegang tot de bureaubladsessie op het externe apparaat, controleer of er een sessie actief is en of GameDesk die kan gebruiken"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk kon geen bruikbaar scherm verkrijgen van de XDG Desktop Portal, de PipeWire-bibliotheek is mogelijk te oud"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk kon een GStreamer-component die nodig is voor schermopname niet laden ({})"),
