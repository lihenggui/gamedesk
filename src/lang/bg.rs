...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Свързване с GameDesk мрежата..."),
        ...
        ("install_tip", "Поради UAC, GameDesk в някои случай не може да работи правилно за отдалечена достъп. За да заобиколите UAC, моля, натиснете копчето по-долу, за да поставите GameDesk като системна услуга."),
        ("Click to upgrade", "Натиснете, за да надстроите"),
        ("Configure", "Настройване"),
        ("config_acc", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на GameDesk права от раздел \"Достъпност\"."),
        ("config_screen", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на GameDesk права от раздел \"Запис на екрана\"."),
        ...
        ("Discovered", "Открит"),
        ("install_daemon_tip", "За зареждане при стартиране на ОС трябва да инсталирате GameDesk като системна услуга."),
        ...
        ("android_input_permission_tip1", "За да може отдалечено устройство да управлява вашето Android устройство чрез мишка или допир, трябва да разрешите на GameDesk да използва услугата \"Достъпност\"."),
        ("android_input_permission_tip2", "Моля, отидете на следващата страница със системни настройки, намерете и въведете [Installed Services], включете услугата [GameDesk Input]."),
        ...
        ("Language", "Език"),
        ("Keep GameDesk background service", "Запази GameDesk фоновата услуга"),
        ("Ignore Battery Optimizations", "Игнорирай оптимизациите на батерията"),
        ("android_open_battery_optimizations_tip", "Ако искате да деактивирате тази функция, моля, отидете на следващата страница с настройки на приложението GameDesk, намерете и въведете [Battery], премахнете отметката от [Unrestricted]"),
        ...
        ("config_input", "За да управлявате отдалечена среда с клавиатура, трябва да предоставите на GameDesk право за \"Input Monitoring\"."),
        ("config_microphone", "За да говорите отдалечено, трябва да предоставите на GameDesk право за \"Запис на звук\"."),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да натисне върху OK в прозореца на UAC при стартиран GameDesk."),
        ...
        ("verify_rustdesk_password_tip", "Проверете GameDesk паролата"),
        ...
        ("scam_text1", "Ако разговаряте по телефона с някой, когото НЕ ПОЗНАВАТЕ и НЯМАТЕ ДОВЕРИЕ, който ви е помолил да използвате GameDesk и да стартирате услугата, не продължавайте и затворете незабавно."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Моля обновете GameDesk Server Pro на версия {} или по-нова!"),
        ...
        ("selinux_tip", "SELinux е активиран на вашето устройство, което може да попречи на GameDesk да работи правилно като контролирана страна."),
        ...
        ("powered_by_me", "Работи с GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Разрешаване на връзка само ако прозорецът на GameDesk е отворен"),
        ...
        ("floating_window_tip", "Помага за поддържане на фоновата услуга на GameDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Моля, надстройте клиента GameDesk до версия {} или по-нова от отдалечената страна!"),
        ...
        ("allow-insecure-tls-fallback-tip", "По подразбиране GameDesk проверява сертификата на сървъра за протоколи, използващи TLS.\nКогато тази опция е активирана, GameDesk ще пропусне стъпката на проверка и ще продължи в случай на неуспешна проверка."),
        ("Disable UDP", "Забрана на UDP"),
        ("disable-udp-tip", "Управлява дали да се използва само TCP.\nКогато тази опция е активирана, GameDesk вече няма да използва UDP 20116, а вместо това ще се използва TCP 20116."),
        ("server-oss-not-support-tip", "ЗАБЕЛЕЖКА: GameDesk server OSS не включва тази функция."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk не може да достигне сесията на работния плот на отдалеченото устройство, проверете дали сесията работи и дали GameDesk може да я използва"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk не можа да получи използваем екран от XDG Desktop Portal, библиотеката PipeWire може да е твърде стара"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk не можа да зареди компонент на GStreamer, необходим за заснемане на екрана ({})"),
