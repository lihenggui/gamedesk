...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til GameDesk-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan GameDesk ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere GameDesk på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give GameDesk \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give GameDesk \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give GameDesk mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [GameDesk Input] tjenesten."),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep GameDesk background service", "Behold GameDesk baggrundstjeneste"),
        ("Ignore Battery Optimizations", "Ignorér betteri optimeringer"),
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn GameDesk appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia-grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open source-driveren, og aktivere software-rendering. En genstart af GameDesk er nødvendig."),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC-vinduet ved kørsel af GameDesk."),
        ...
        ("verify_rustdesk_password_tip", "Bekræft GameDesk-adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge GameDesk til at forbinde til din PC, så stop med det samme, og læg på omgående."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Opgradér venligst GameDesk Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, hvilket kan forhindre GameDesk i at køre normalt."),
        ...
        ("powered_by_me", "Drives af GameDesk"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af GameDesk med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis GameDesk-vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper til at holde GameDesk-baggrundstjenesten kørende"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Opgrader venligst GameDesk-klienten til version {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verificerer GameDesk servercertifikatet for protokoller, der bruger TLS.\nNår denne indstilling er aktiveret, vil GameDesk springe verificeringstrinnet over og fortsætte, hvis verificeringen mislykkes."),
        ("Disable UDP", "Deaktivér UDP"),
        ("disable-udp-tip", "Bestemmer, om der kun skal bruges TCP.\nNår denne indstilling er aktiveret, vil GameDesk ikke længere bruge UDP 20116; i stedet bruges TCP 20116."),
        ("server-oss-not-support-tip", "BEMÆRK: GameDesk Server OSS indeholder ikke denne funktion."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk kan ikke nå skrivebordssessionen på fjernenheden, kontrollér at en session kører, og at GameDesk kan bruge den"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk kunne ikke få en brugbar skærm fra XDG Desktop Portal, PipeWire-biblioteket er måske for gammelt"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk kunne ikke indlæse en GStreamer-komponent, der kræves til skærmoptagelse ({})"),
