...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο GameDesk..."),
        ...
        ("install_tip", "Λόγω UAC, το GameDesk ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το GameDesk στο σύστημα"),
        ("Click to upgrade", "Κάντε κλίκ για αναβάθμιση τώρα"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για να ελέγξετε την επιφάνεια εργασίας σας από απόσταση, πρέπει να παραχωρήσετε στο GameDesk το δικαίωμα της \"Προσβασιμότητας\"."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στην επιφάνεια εργασίας σας, πρέπει να παραχωρήσετε στο GameDesk το δικαίωμα της \"Εγγραφή οθόνης\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο GameDesk να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλούμε να μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος GameDesk]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep GameDesk background service", "Διατήρηση της υπηρεσίας παρασκηνίου του GameDesk"),
        ...
        ("Show GameDesk", "Εμφάνιση του GameDesk"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με το πληκτρολόγιο, πρέπει να παραχωρήσετε στο GameDesk το δικαίωμα της \"Παρακολούθηση εισόδου\"."),
        ("config_microphone", "Για να μιλήσετε εξ αποστάσεως, πρέπει να παραχωρήσετε στο GameDesk το δικαίωμα της \"Εγγραφή ήχου\"."),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο πλήκτρο Εντάξει στο παράθυρο UAC όπου εκτελείται το GameDesk."),
        ...
        ("verify_rustdesk_password_tip", "Επιβεβαιώστε τον κωδικό του GameDesk"),
        ...
        ("scam_text1", "Αν σας καλέσει κάποιος τον οποίο ΔΕΝ γνωρίζεται και ΔΕΝ ΕΜΠΙΣΤΕΥΕΣΤΕ, και σας ζητήσει να ανοίξετε το GameDesk, και να του πείτε τα στοιχεία που εμφανίζει, ΜΗΝ συνεχίσετε και κλείστε το τηλέφωνο ΑΜΕΣΩΣ."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε το GameDesk Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("selinux_tip", "Το SELinux είναι ενεργοποιημένο στη συσκευή σας, κάτι που ενδέχεται να εμποδίσει την σωστή λειτουργία του GameDesk ως ελεγχόμενης πλευράς."),
        ...
        ("powered_by_me", "Με την υποστήριξη του GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Να επιτρέπεται η σύνδεση μόνο εάν το παράθυρο GameDesk είναι ανοιχτό"),
        ...
        ("floating_window_tip", "Βοηθά στη διατήρηση της υπηρεσίας παρασκηνίου GameDesk"),
        ...
        ("About GameDesk", "Πληροφορίες για το GameDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Αναβαθμίστε τον πελάτη GameDesk στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Από προεπιλογή, το GameDesk επαληθεύει το πιστοποιητικό διακομιστή για πρωτόκολλα που χρησιμοποιούν TLS.\nΜε ενεργοποιημένη αυτήν την επιλογή, το GameDesk θα παρακάμψει το βήμα επαλήθευσης και θα προχωρήσει σε περίπτωση αποτυχίας επαλήθευσης."),
        ("Disable UDP", "Απενεργοποίηση UDP"),
        ("disable-udp-tip", "Ελέγχει εάν θα χρησιμοποιείται μόνο TCP.\nΌταν είναι ενεργοποιημένη αυτή η επιλογή, το GameDesk δεν θα χρησιμοποιεί πλέον το UDP 20116, αλλά θα χρησιμοποιείται το TCP 20116."),
        ("server-oss-not-support-tip", "ΣΗΜΕΙΩΣΗ: Το OSS του διακομιστή GameDesk δεν περιλαμβάνει αυτήν τη λειτουργία."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "Το GameDesk δεν μπορεί να προσεγγίσει τη συνεδρία επιφάνειας εργασίας στην απομακρυσμένη συσκευή, ελέγξτε ότι μια συνεδρία εκτελείται και ότι το GameDesk μπορεί να τη χρησιμοποιήσει"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "Το GameDesk δεν μπόρεσε να λάβει αξιοποιήσιμη οθόνη από το XDG Desktop Portal, η βιβλιοθήκη PipeWire ίσως είναι πολύ παλιά"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "Το GameDesk δεν μπόρεσε να φορτώσει ένα στοιχείο του GStreamer που απαιτείται για την καταγραφή οθόνης ({})"),
