...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "GameDesk ქსელთან დაკავშირება..."),
        ...
        ("install_tip", "ზოგიერთ შემთხვევაში UAC-ის გამო GameDesk შეიძლება არასწორად მუშაობდეს დაშორებულ კვანძზე. UAC-თან დაკავშირებული პრობლემების თავიდან ასაცილებლად დააჭირეთ ქვემოთ მოცემულ ღილაკს სისტემაში GameDesk-ის დასაყენებლად."),
        ("Click to upgrade", "დააჭირეთ განახლებისთვის"),
        ("Configure", "კონფიგურაცია"),
        ("config_acc", "თქვენი სამუშაო მაგიდის დისტანციური მართვისთვის უნდა მიანიჭოთ GameDesk-ს \"წვდომის\" უფლებები"),
        ("config_screen", "სამუშაო მაგიდაზე დისტანციური წვდომისთვის უნდა მიანიჭოთ GameDesk-ს \"ეკრანის ანაბეჭდის\" უფლებები"),
        ...
        ("android_input_permission_tip1", "იმისთვის, რომ დაშორებულმა მოწყობილობამ შეძლოს თქვენი Android-მოწყობილობის მართვა თაგუნათი ან შეხებით, საჭიროა GameDesk-ისთვის \"სპეციალური შესაძლებლობების\" სერვისის გამოყენების უფლების მინიჭება."),
        ("android_input_permission_tip2", "გადადით სისტემის პარამეტრების შესაბამის გვერდზე, იპოვეთ და შედით \"დაინსტალირებულ სერვისებში\", ჩართეთ \"GameDesk Input\" სერვისი."),
        ...
        ("Language", "ენა"),
        ("Keep GameDesk background service", "GameDesk-ის ფონური სერვისის შენარჩუნება"),
        ...
        ("Show GameDesk", "GameDesk-ის ჩვენება"),
        ...
        ("config_input", "დისტანციური სამუშაო მაგიდის კლავიატურით სამართავად, საჭიროა GameDesk-ისთვის \"შეყვანის მონიტორინგის\" უფლების მინიჭება."),
        ("config_microphone", "დისტანციურ მხარესთან სასაუბროდ, საჭიროა GameDesk-ისთვის \"აუდიოს ჩაწერის\" უფლების მინიჭება."),
        ...
        ("still_click_uac_tip", "კვლავ საჭიროა, რომ დისტანციურმა მომხმარებელმა დააჭიროს \"OK\"-ს UAC ფანჯარაში GameDesk-ის გაშვებისას."),
        ...
        ("verify_rustdesk_password_tip", "დაადასტურეთ GameDesk-ის პაროლი"),
        ...
        ("scam_text1", "თუ ტელეფონით ესაუბრებით ვინმეს, ვისაც არ იცნობთ და არ ენდობით, და ის გთხოვთ გამოიყენოთ GameDesk და გაუშვათ მისი სერვისი, არ გააგრძელოთ და დაუყოვნებლივ შეწყვიტეთ საუბარი."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "განაახლეთ GameDesk Server Pro ვერსიამდე {} ან უფრო ახალი!"),
        ...
        ("selinux_tip", "თქვენს მოწყობილობაზე ჩართულია SELinux, რამაც შეიძლება ხელი შეუშალოს GameDesk-ის სწორ მუშაობას მართულ მხარეზე."),
        ("Change view", "ხედი"),
        ...
        ("powered_by_me", "GameDesk-ზე დაფუძნებული"),
        ...
        ("allow-only-conn-window-open-tip", "დაშვება მხოლოდ მაშინ, როცა GameDesk-ის ფანჯარა გახსნილია"),
        ...
        ("floating_window_tip", "ეხმარება GameDesk-ის ფონური სერვისის შენარჩუნებას"),
        ...
        ("About GameDesk", "GameDesk-ის შესახებ"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "განაახლეთ GameDesk კლიენტი ვერსიამდე {} ან უფრო ახალი დისტანციურ მხარეზე!"),
        ...
        ("allow-insecure-tls-fallback-tip", "ნაგულისხმევად GameDesk ამოწმებს სერვერის სერტიფიკატს TLS-ის გამოყენებისას პროტოკოლებისთვის.\nამ პარამეტრის ჩართვისას GameDesk გადავა შემოწმების ეტაპის გამოტოვებაზე და გააგრძელებს მუშაობას შემოწმების წარუმატებლობის შემთხვევაში."),
        ("Disable UDP", "UDP-ის გამორთვა"),
        ("disable-udp-tip", "აკონტროლებს, გამოვიყენოთ თუ არა მხოლოდ TCP.\nამ პარამეტრის ჩართვისას GameDesk აღარ გამოიყენებს UDP 20116-ს, სანაცვლოდ გამოყენებული იქნება TCP 20116."),
        ("server-oss-not-support-tip", "შენიშვნა: GameDesk server OSS არ მოიცავს ამ ფუნქციას."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk-ს არ შეუძლია დისტანციური მოწყობილობის სამუშაო მაგიდის სესიასთან წვდომა, შეამოწმეთ, რომ სესია გაშვებულია და GameDesk-ს შეუძლია მისი გამოყენება"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk-მა ვერ მიიღო გამოსადეგი ეკრანი XDG Desktop Portal-იდან, PipeWire-ის ბიბლიოთეკა შესაძლოა ძალიან ძველია"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk-მა ვერ ჩატვირთა ეკრანის ჩაწერისთვის საჭირო GStreamer-ის კომპონენტი ({})"),
