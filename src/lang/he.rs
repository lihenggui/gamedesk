...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "מוכן"),
        ("Established", "מחובר"),
        ("connecting_status", "מתחבר לרשת GameDesk..."),
        ...
        ("install_tip", "בגלל UAC, GameDesk לא יכול לפעול כראוי כצד מרוחק בחלק מהמקרים. כדי להימנע מ-UAC, אנא לחץ על הכפתור למטה כדי להתקין את GameDesk במערכת."),
        ("Click to upgrade", "לחץ כדי לשדרג"),
        ("Configure", "הגדר"),
        ("config_acc", "כדי לשלוט מרחוק בשולחן העבודה שלך, עליך להעניק ל-GameDesk הרשאות \"נגישות\"."),
        ("config_screen", "כדי לגשת מרחוק לשולחן העבודה שלך, עליך להעניק ל-GameDesk הרשאות \"הקלטת מסך\"."),
        ("Installing ...", "מתקין ..."),
        ("Install", "התקן"),
        ("Installation", "התקנה"),
        ...
        ("android_input_permission_tip1", "כדי שמכשיר מרוחק יוכל לשלוט במכשיר האנדרואיד שלך באמצעות עכבר או מגע, עליך לאפשר ל-GameDesk להשתמש בשירות \"נגישות\"."),
        ("android_input_permission_tip2", "אנא עבור לדף הגדרות המערכת הבא, מצא והכנס ל[שירותים מותקנים], הפעל את שירות [GameDesk Input]."),
        ...
        ("Turned off", "מכובה"),
        ("Language", "שפה"),
        ("Keep GameDesk background service", "השאר את שירות הרקע של GameDesk פעיל"),
        ("Ignore Battery Optimizations", "התעלם מאופטימיזציות סוללה"),
        ("android_open_battery_optimizations_tip", "אם ברצונך לבטל תכונה זו, אנא עבור לדף ההגדרות של יישום GameDesk , מצא והיכנס ל[סוללה], ובטל את הסימון מ-[לא מוגבל]"),
        ...
        ("config_input", "כדי לשלוט בשולחן העבודה המרוחק באמצעות מקלדת, עליך להעניק ל-GameDesk הרשאות \"מעקב קלט\"."),
        ("config_microphone", "כדי לדבר מרחוק, עליך להעניק ל-GameDesk הרשאות \"הקלטת שמע\"."),
        ...
        ("still_click_uac_tip", "עדיין נדרש מהמשתמש המרוחק לאשר את חלון ה-UAC של GameDesk"),
        ...
        ("View Mode", "מצב תצוגה"),
        ("verify_rustdesk_password_tip", "אמת סיסמת GameDesk"),
        ...
        ("scam_text1", "אם אתה בשיחת טלפון עם מישהו שאינך מכיר ואינך סומך עליו שביקש ממך להשתמש ב-GameDesk ולהתחיל את השירות, אל תמשיך ונתק מיד."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "אנא שדרג את GameDesk Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("selinux_tip", "SELinux מופעל במכשיר שלך, מה שעלול למנוע מ-GameDesk לפעול כראוי כצד הנשלט."),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "אנא שדרג את לקוח GameDesk לגרסה {} או חדשה יותר בצד המרוחק!"),
        ...
        ("allow-insecure-tls-fallback-tip", "כברירת מחדל, GameDesk מאמת את אישור השרת עבור פרוטוקולים המשתמשים ב-TLS.\nכאשר אפשרות זו מופעלת, GameDesk יחזור לדילוג על שלב האימות וימשיך במקרה של כשל באימות."),
        ("Disable UDP", "השבת UDP"),
        ("disable-udp-tip", "קובע אם להשתמש ב-TCP בלבד.\nכאשר אפשרות זו מופעלת, GameDesk לא ישתמש יותר ב-UDP 20116, ובמקום זאת ייעשה שימוש ב-TCP 20116."),
        ("server-oss-not-support-tip", "הערה: גרסת ה-OSS של שרת GameDesk אינה כוללת תכונה זו."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk אינו יכול לגשת להפעלת שולחן העבודה במכשיר המרוחק, ודאו שההפעלה פועלת ושGameDesk יכול להשתמש בה"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk לא הצליח לקבל מסך שמיש מ-XDG Desktop Portal, ייתכן שספריית PipeWire ישנה מדי"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk לא הצליח לטעון רכיב GStreamer הדרוש ללכידת מסך ({})"),
