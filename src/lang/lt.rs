...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Prisijungiama prie GameDesk tinklo..."),
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti GameDesk netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte GameDesk į savo kompiuterį."),
        ("Click to upgrade", "Spustelėkite, jei norite atnaujinti"),
        ("Configure", "Konfigūruoti"),
        ("config_acc", "Norėdami nuotoliniu būdu valdyti darbalaukį, turite suteikti GameDesk \"prieigos\" leidimus"),
        ("config_screen", "Norėdami nuotoliniu būdu pasiekti darbalaukį, turite suteikti GameDesk leidimus \"ekrano kopija\""),
        ("Installing ...", "Diegiama ..."),
        ("Install", "Diegti"),
        ...
        ("install_daemon_tip", "Norėdami, kad GameDesk startuotų automatiškai, turite ją įdiegti"),
        ...
        ("android_input_permission_tip1", "Kad nuotolinis įrenginys galėtų valdyti Android įrenginį pele arba liesti, turite leisti GameDesk naudoti \"Prieinamumo\" paslaugą."),
        ("android_input_permission_tip2", "Eikite į kitą sistemos nustatymų puslapį, suraskite \"Įdiegtos paslaugos\" ir įgalinkite \"GameDesk įvestis\" paslaugą."),
        ...
        ("Turned off", "Išjungti"),
        ("Language", "Kalba"),
        ("Keep GameDesk background service", "Palikti GameDesk fonine paslauga"),
        ...
        ("config_input", "Norėdami valdyti nuotolinį darbalaukį naudodami klaviatūrą, turite suteikti GameDesk leidimus \"Įvesties monitoringas\"."),
        ("config_microphone", "Norėdami kalbėtis su nuotoline puse, turite suteikti GameDesk leidimą \"Įrašyti garsą\"."),
        ...
        ("still_click_uac_tip", "Vis tiek reikia, kad nuotolinis vartotojas paleidžiant GameDesk UAC lange paspaustų \"OK\"."),
        ...
        ("verify_rustdesk_password_tip", "Įveskite kliento GameDesk slaptažodį"),
        ...
        ("scam_text1", "Jei kalbatės telefonu su žmogumi, kurio NEPAŽĮSTATE ir kuriuo NEPASITIKITE, ir jis paprašė jūsų naudoti GameDesk bei paleisti paslaugą, netęskite ir nedelsdami padėkite ragelį."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prašome atnaujinti GameDesk Server Pro į versiją {} ar naujesnę!"),
        ...
        ("selinux_tip", "Jūsų įrenginyje įjungtas SELinux, kuris gali trukdyti GameDesk tinkamai veikti kaip valdomajai pusei."),
        ...
        ("powered_by_me", "Veikia su GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Leisti prisijungti tik tada, kai atidarytas GameDesk langas"),
        ...
        ("floating_window_tip", "Tai padeda išlaikyti GameDesk foninę paslaugą"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės GameDesk klientą į {} ar naujesnę versiją!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pagal numatytuosius nustatymus GameDesk tikrina serverio sertifikatą protokoluose, naudojančiuose TLS.\nĮgalinus šią parinktį, patikros nesėkmės atveju GameDesk praleis patikros veiksmą ir tęs darbą."),
        ("Disable UDP", "Išjungti UDP"),
        ("disable-udp-tip", "Nurodo, ar naudoti tik TCP.\nĮgalinus šią parinktį, GameDesk nebenaudos UDP 20116, vietoj jo bus naudojamas TCP 20116."),
        ("server-oss-not-support-tip", "PASTABA: GameDesk serverio OSS šios funkcijos neturi."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk negali pasiekti nuotolinio įrenginio darbalaukio seanso, patikrinkite, ar seansas veikia ir ar GameDesk gali jį naudoti"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk negavo tinkamo ekrano iš XDG Desktop Portal, PipeWire biblioteka gali būti per sena"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk nepavyko įkelti ekrano įrašymui reikalingo GStreamer komponento ({})"),
