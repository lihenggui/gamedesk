...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na GameDesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a GameDesk ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate GameDesk na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, GameDesk-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, GameDesk-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti GameDesk-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [GameDesk Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep GameDesk background service", "Zadrži GameDesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje GameDesk aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show GameDesk", "Prikaži GameDesk"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti GameDesku dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti GameDesku \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog GameDeska."),
        ...
        ("verify_rustdesk_password_tip", "Provjera lozinke za GameDesk"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete GameDesk, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Ažurirajte GameDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti GameDesk da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti vezu samo ako je prozor GameDeska otvoren"),
        ...
        ("floating_window_tip", "Pomaže u održavanju pozadinskog servisa GameDeska"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo ažurirajte GameDesk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Prema zadanim postavkama, GameDesk provjerava certifikat poslužitelja za protokole koji koriste TLS.\nKada je ova opcija omogućena, GameDesk će u slučaju neuspjele provjere preskočiti korak provjere i nastaviti."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Određuje hoće li se koristiti samo TCP.\nKada je ova opcija omogućena, GameDesk više neće koristiti UDP 20116, već će umjesto toga koristiti TCP 20116."),
        ("server-oss-not-support-tip", "NAPOMENA: GameDesk poslužitelj OSS ne uključuje ovu značajku."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk ne može pristupiti sesiji radne površine na udaljenom uređaju, provjerite radi li sesija i može li je GameDesk koristiti"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk nije mogao dobiti upotrebljiv zaslon od XDG Desktop Portala, PipeWire biblioteka je možda prestara"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk nije mogao učitati GStreamer komponentu potrebnu za snimanje zaslona ({})"),
