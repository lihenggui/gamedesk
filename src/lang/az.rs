...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Hazır"),
        ("Established", "Quruldu"),
        ("connecting_status", "GameDesk şəbəkəsinə qoşulur..."),
        ...
        ("install_tip", "UAC səbəbindən GameDesk bəzi hallarda uzaq tərəf kimi düzgün işləyə bilmir. UAC-dan yayınmaq üçün aşağıdakı düyməyə basaraq GameDesk-i sistemə quraşdırın."),
        ("Click to upgrade", "Yeniləmək üçün klikləyin"),
        ("Configure", "Konfiqurasiya et"),
        ("config_acc", "Masaüstünüzü uzaqdan idarə etmək üçün GameDesk-ə \"Əlçatanlıq\" icazələrini verməlisiniz."),
        ("config_screen", "Masaüstünüzə uzaqdan giriş üçün GameDesk-ə \"Ekran Yazısı\" icazələrini verməlisiniz."),
        ...
        ("android_input_permission_tip1", "Uzaq cihazın siçan və ya toxunuşla Android cihazınızı idarə etməsi üçün GameDesk-ə \"Əlçatanlıq\" xidmətindən istifadə icazəsi verməlisiniz."),
        ("android_input_permission_tip2", "Növbəti sistem parametrləri səhifəsinə keçin, [Quraşdırılmış xidmətlər] bölməsini tapıb açın və [GameDesk Input] xidmətini işə salın."),
        ...
        ("Language", "Dil"),
        ("Keep GameDesk background service", "GameDesk fon xidmətini işlək saxla"),
        ("Ignore Battery Optimizations", "Batareya optimallaşdırmalarını nəzərə alma"),
        ("android_open_battery_optimizations_tip", "Bu funksiyanı söndürmək istəyirsinizsə, növbəti GameDesk tətbiq parametrləri səhifəsinə keçin, [Batareya] bölməsini tapıb açın və [Məhdudiyyətsiz] seçimini götürün"),
        ...
        ("Show GameDesk", "GameDesk-i göstər"),
        ("This PC", "Bu kompüter"),
        ("or", "və ya"),
        ...
        ("config_input", "Uzaq masaüstünü klaviatura ilə idarə etmək üçün GameDesk-ə \"Giriş Monitorinqi\" icazələrini verməlisiniz."),
        ("config_microphone", "Uzaqdan danışmaq üçün GameDesk-ə \"Audio Yazısı\" icazələrini verməlisiniz."),
        ...
        ("still_click_uac_tip", "Yenə də uzaq istifadəçinin işləyən GameDesk-in UAC pəncərəsində OK düyməsini basması tələb olunur."),
        ...
        ("verify_rustdesk_password_tip", "GameDesk parolunu doğrula"),
        ...
        ("scam_text1", "Tanımadığınız və ETİBAR ETMƏDİYİNİZ biri telefonda sizdən GameDesk işlətməyi və xidməti başlatmağı xahiş edirsə, davam etməyin və dərhal telefonu bağlayın."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "GameDesk Server Pro-nu {} və ya daha yeni versiyaya yüksəldin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux aktivdir, bu, GameDesk-in idarə olunan tərəf kimi düzgün işləməsinə mane ola bilər."),
        ...
        ("powered_by_me", "GameDesk ilə işləyir"),
        ...
        ("allow-only-conn-window-open-tip", "Əlaqəyə yalnız GameDesk pəncərəsi açıq olduqda icazə ver"),
        ...
        ("floating_window_tip", "GameDesk fon xidmətini işlək saxlamağa kömək edir"),
        ...
        ("About GameDesk", "GameDesk haqqında"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Uzaq tərəfdə GameDesk klientini {} və ya daha yeni versiyaya yüksəldin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standart olaraq GameDesk TLS işlədən protokollar üçün server sertifikatını yoxlayır.\nBu seçim aktiv olduqda, yoxlama alınmadığı halda GameDesk yoxlama addımını keçib davam edəcək."),
        ("Disable UDP", "UDP-ni söndür"),
        ("disable-udp-tip", "Yalnız TCP işlədilib işlədilməyəcəyini idarə edir.\nBu seçim aktiv olduqda GameDesk artıq UDP 21116 işlətməyəcək, əvəzində TCP 21116 işlədiləcək."),
        ("server-oss-not-support-tip", "QEYD: GameDesk server OSS bu funksiyanı əhatə etmir."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", ""),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", ""),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", ""),
