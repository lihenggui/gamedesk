...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établie"),
        ("connecting_status", "Connexion au réseau GameDesk…"),
        ...
        ("install_tip", "GameDesk n’est pas installé, ce qui peut limiter son utilisation à cause de l’UAC. Cliquez ci-dessous pour l’installer."),
        ...
        ("android_input_permission_tip1", "Pour qu’un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher d’écran, vous devez autoriser GameDesk à utiliser le service « Accessibilité »."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, puis recherchez et accédez à la section [Services installés] ; activez ensuite le service [GameDesk Input]."),
        ...
        ("Language", "Langue"),
        ("Keep GameDesk background service", "Garder le service GameDesk en arrière plan"),
        ("Ignore Battery Optimizations", "Ignorer les optimisations de la batterie"),
        ("android_open_battery_optimizations_tip", "Pour désactiver cette fonctionnalité, veuillez accéder à la page suivante des paramètres de l’application GameDesk, puis recherchez et accédez à la section [Batterie] ; décochez ensuite l’option [Sans restriction]."),
        ...
        ("Show GameDesk", "Afficher GameDesk"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Vous devez accorder à GameDesk l’autorisation « Surveillance de l’entrée » pour contrôler le bureau distant avec le clavier."),
        ("config_microphone", "Vous devez accorder à GameDesk l’autorisation « Enregistrer l’audio » pour discuter à distance."),
        ...
        ("still_click_uac_tip", "L’utilisateur distant devra malgré tout confirmer l’UAC de l’instance GameDesk en cours d’éxécution."),
        ...
        ("View Mode", "Mode vue"),
        ("verify_rustdesk_password_tip", "Vérifier le mot de passe GameDesk"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu’un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N’AVEZ PAS CONFIANCE et qui vous a demandé d’utiliser GameDesk et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Veuillez mettre à jour GameDesk Server Pro vers la version {} ou une version ultérieure !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher GameDesk de fonctionner correctement sur la machine contrôlée."),
        ...
        ("powered_by_me", "Utilise la technologie GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "N’autoriser la connexion que si la fenêtre GameDesk est ouverte"),
        ...
        ("About GameDesk", "À propos de GameDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Veuillez mettre le client GameDesk distant à jour vers la version {} ou ultérieure !"),
        ...
        ("allow-insecure-tls-fallback-tip", "Par défaut, GameDesk vérifie le certificat du serveur lors de l’utilisation de protocoles utilisant TLS.\nLorsque cette option est activée, GameDesk autorise les connexions même en cas d’échec de l’étape de vérification."),
        ("Disable UDP", "Désactiver UDP"),
        ("disable-udp-tip", "Contrôle l’utilisation exclusive du mode TCP.\nLorsque cette option est activée, GameDesk n’utilise plus le port UDP 20116 et utilise le port TCP 20116 à la place."),
        ("server-oss-not-support-tip", "Note : Cette fonctionnalité n’est pas disponible sous la version open-source du serveur GameDesk."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk ne peut pas accéder à la session de bureau de l'appareil distant, vérifiez qu'une session est ouverte et que GameDesk peut l'utiliser"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk n'a pas pu obtenir d'écran exploitable auprès du XDG Desktop Portal, la bibliothèque PipeWire est peut-être trop ancienne"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk n'a pas pu charger un composant GStreamer nécessaire à la capture d'écran ({})"),
