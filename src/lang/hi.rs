...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "कृपया सिस्टम सेटिंग में GameDesk खोजें और इसे चालू करें।"),
        ...
        ("Language", "भाषा"),
        ("Keep GameDesk background service", "GameDesk बैकग्राउंड सेवा चालू रखें"),
        ...
        ("View Mode", "व्यू मोड"),
        ("verify_rustdesk_password_tip", "GameDesk पासवर्ड सत्यापित करें"),
        ...
        ("scam_text1", "यदि आप किसी ऐसे व्यक्ति से बात कर रहे हैं जिसे आप नहीं जानते और जिसने आपसे GameDesk उपयोग करने को कहा है, तो तुरंत डिस्कनेक्ट कर दें।"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "GameDesk सर्वर प्रो को संस्करण {} में अपग्रेड करें"),
        ...
        ("allow-only-conn-window-open-tip", "केवल तभी कनेक्शन की अनुमति दें जब GameDesk विंडो खुली हो"),
        ...
        ("floating_window_tip", "बैकग्राउंड में रहने के दौरान GameDesk को दिखाएं"),
        ...
        ("About GameDesk", "GameDesk के बारे में"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "रिमोट GameDesk क्लाइंट को संस्करण {} में अपग्रेड करें"),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk रिमोट डिवाइस के डेस्कटॉप सत्र तक नहीं पहुँच सकता, जाँचें कि डेस्कटॉप सत्र चल रहा है और GameDesk उसका उपयोग कर सकता है"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk XDG Desktop Portal से उपयोग योग्य स्क्रीन प्राप्त नहीं कर सका, PipeWire लाइब्रेरी बहुत पुरानी हो सकती है"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk स्क्रीन कैप्चर के लिए आवश्यक GStreamer घटक लोड नहीं कर सका ({})"),
