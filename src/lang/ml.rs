...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "സെറ്റിംഗ്സിൽ GameDesk കണ്ടെത്തി അത് ഓൺ ചെയ്യുക."),
        ...
        ("Language", "ഭാഷ"),
        ("Keep GameDesk background service", "GameDesk ബാക്ക്ഗ്രൗണ്ടിൽ പ്രവർത്തിപ്പിക്കുക"),
        ...
        ("Show GameDesk", "GameDesk കാണിക്കുക"),
        ("This PC", "ഈ പിസി"),
        ("or", "അല്ലെങ്കിൽ"),
        ...
        ("View Mode", "വ്യൂ മോഡ്"),
        ("verify_rustdesk_password_tip", "GameDesk പാസ്‌വേഡ് പരിശോധിക്കുക"),
        ...
        ("scam_text1", "നിങ്ങൾക്ക് പരിചയമില്ലാത്ത ആരെങ്കിലും GameDesk ഉപയോഗിക്കാൻ ആവശ്യപ്പെട്ടാൽ ഉടൻ കണക്ഷൻ വിച്ഛേദിക്കുക."),
        ...
        ("allow-only-conn-window-open-tip", "GameDesk വിൻഡോ തുറന്നിരിക്കുമ്പോൾ മാത്രം കണക്ഷൻ അനുവദിക്കുക"),
        ...
        ("floating_window_tip", "ബാക്ക്ഗ്രൗണ്ടിലാണെങ്കിലും GameDesk കാണിക്കുക"),
        ...
        ("About GameDesk", "GameDesk-നെ കുറിച്ച്"),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk-ന് വിദൂര ഉപകരണത്തിലെ ഡെസ്ക്ടോപ്പ് സെഷനിലേക്ക് എത്താൻ കഴിയുന്നില്ല, സെഷൻ പ്രവർത്തിക്കുന്നുണ്ടെന്നും GameDesk-ന് അത് ഉപയോഗിക്കാമെന്നും ഉറപ്പാക്കുക"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "XDG Desktop Portal-ൽ നിന്ന് ഉപയോഗയോഗ്യമായ സ്ക്രീൻ GameDesk-ന് ലഭിച്ചില്ല, PipeWire ലൈബ്രറി വളരെ പഴയതാകാം"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "സ്ക്രീൻ പകർത്താൻ ആവശ്യമായ GStreamer ഘടകം GameDesk-ന് ലോഡ് ചെയ്യാനായില്ല ({})"),
