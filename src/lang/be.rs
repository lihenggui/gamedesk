...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ідзе падключэнне да сеткі GameDesk..."),
        ...
        ("install_tip", "У некаторых выпадках з-за UAC, GameDesk можа працаваць на баку абанента неадпаведным чынам. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўсталявання GameDesk у сістэме."),
        ("Click to upgrade", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам трэба дазволіць GameDesk правы \"доступу\""),
        ("config_screen", "Для аддаленага доступу да працоўнага стала вам трэба даць GameDesk правы \"здымку экрана\"."),
        ...
        ("android_input_permission_tip1", "Каб аддаленая прылада магла кіраваць вашай Android-прыладай з дапамогай мышы або націсканняў, трэба дазволіць GameDesk выкарыстоўваць службу \"Спецыяльныя магчымасці\"."),
        ("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і перайдзіце ва \"Усталяваныя службы\", уключыце службу \"GameDesk Input\"."),
        ...
        ("Language", "Мова"),
        ("Keep GameDesk background service", "Захаваць фонавую службу GameDesk"),
        ...
        ("Show GameDesk", "Паказаць GameDesk"),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, трэба дазволіць GameDesk \"Маніторынг уводу\"."),
        ("config_microphone", "Каб размаўляць з абанентам, трэба дазволіць GameDesk запіс аўдыя."),
        ...
        ("still_click_uac_tip", "Дагэтуль патрэбна, каб абанент націснуў \"OK\" ў акне UAC пры запуску GameDesk."),
        ...
        ("verify_rustdesk_password_tip", "Пацвердзіць пароль GameDesk"),
        ...
        ("scam_text1", "Калі вы размаўляеце па тэлефоне з кімсьці НЕЗНАЁМЫМ і каму вы НЕ ДАВЕРАЕЦЕ, і гэта асоба просіць вас выкарыстаць GameDesk і запусціць яго службу, не працягвайце і неадкладна скончыце размову."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Абнавіце GameDesk Server Pro да версіі {} або навейшай!"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа ствараць перашкоды ў працы GameDesk на баку абанента."),
        ("Change view", "Рэжым"),
        ...
        ("powered_by_me", "Заснавана на GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць падключэнне толькі пры адкрытым акне GameDesk"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу GameDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Абнавіце кліент GameDesk да версіі {} або навейшай на баку абанента!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Стандартна GameDesk правярае сертыфікат сервера на наяўнасць пратаколаў, якія выкарыстоўваюць TLS.\nКалі гэта функцыя ўключана, GameDesk прапусціць дадзены этап і працягне працу ў выпадку няўдалай праверкі."),
        ("Disable UDP", "Выключыць UDP"),
        ("disable-udp-tip", "Вызначае, ці варта выкарыстоўваць толькі TCP.\nКалі ўключана, GameDesk не будзе выкарыстоўваць UDP 20116, замест чаго будзе выкарыстоўвацца TCP 20116."),
        ("server-oss-not-support-tip", "ЗАЎВАГА! у OSS-серверы GameDesk гэта функцыя адсутнічае."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk не можа атрымаць доступ да сеанса працоўнага стала на аддаленай прыладзе, праверце, ці запушчаны сеанс і ці даступны ён для GameDesk"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk не змог атрымаць прыдатны экран ад XDG Desktop Portal, магчыма бібліятэка PipeWire занадта старая"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk не змог загрузіць кампанент GStreamer, патрэбны для захопу экрана ({})"),
