...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Pripájam sa na GameDesk server..."),
        ...
        ("install_tip", "V niektorých prípadoch GameDesk nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ("Click to upgrade", "Kliknutím nainštalujete aktualizáciu"),
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii GameDesk udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii GameDesk udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii GameDesk udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [GameDesk Input] službu."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep GameDesk background service", "Ponechať službu GameDesk na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovať optimalizácie batérie"),
        ("android_open_battery_optimizations_tip", "Ak chcete túto funkciu vypnúť, prejdite na ďalšiu stránku nastavení GameDesku, vyhľadajte a zadajte položku [Batéria], zrušte začiarknutie položky [Neobmedzené]."),
        ...
        ("Show GameDesk", "Zobraziť GameDesk"),
        ...
        ("config_input", "Ak chcete ovládať vzdialenú plochu pomocou klávesnice, musíte udeliť oprávnenie GameDesk \"Sledovanie vstupu\"."),
        ("config_microphone", "Ak chcete hovoriť na diaľku, musíte GameDesku udeliť povolenie \"Nahrávať zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále sa vyžaduje, aby vzdialený používateľ klikol na tlačidlo OK v okne UAC spusteného programu GameDesk."),
        ...
        ("verify_rustdesk_password_tip", "Overenie hesla GameDesk"),
        ...
        ("scam_text1", "Ak telefonujete s niekým, koho nepoznáte a komu nedôverujete a kto vás požiadal o použitie a spustenie aplikácie GameDesk, nepokračujte v hovore a okamžite zaveste."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aktualizujte GameDesk Server Pro na verziu {} alebo novšiu!"),
        ...
        ("selinux_tip", "Na vašom zariadení je povolený SELinux, čo môže brániť správnemu spusteniu GameDesku ako spravovanej strany."),
        ...
        ("powered_by_me", "Poháňané aplikáciou GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie GameDesk"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu GameDesk na pozadí"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aktualizujte klienta GameDesk na verziu {} alebo novšiu na vzdialenej strane!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Štandardne GameDesk overuje certifikát servera pre protokoly používajúce TLS.\nS touto možnosťou GameDesk v prípade zlyhania overenia preskočí krok overovania a bude pokračovať."),
        ("Disable UDP", "Vypnúť UDP"),
        ("disable-udp-tip", "Určuje, či sa má používať iba TCP.\nKeď je táto možnosť povolená, GameDesk už nebude používať UDP 20116, namiesto neho sa použije TCP 20116."),
        ("server-oss-not-support-tip", "POZNÁMKA: GameDesk server OSS túto funkciu neobsahuje."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk nemá prístup k relácii plochy na vzdialenom zariadení, overte, či relácia beží a či ju GameDesk môže použiť"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk nezískal z XDG Desktop Portal použiteľnú obrazovku, knižnica PipeWire môže byť príliš stará"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk nedokázal načítať komponent GStreamera potrebný na zachytenie obrazovky ({})"),
