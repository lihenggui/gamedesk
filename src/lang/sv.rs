...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till GameDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte GameDesk fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera GameDesk på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge GameDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge GameDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [GameDesk Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep GameDesk background service", "Behåll GameDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa GameDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge GameDesk behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge GameDesk behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för GameDesk."),
        ...
        ("verify_rustdesk_password_tip", "Verifiera GameDesk-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda GameDesk och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Uppgradera GameDesk Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra GameDesk från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om GameDesk-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla GameDesk-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Uppgradera GameDesk-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar GameDesk serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar GameDesk över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder GameDesk inte längre UDP 20116, utan TCP 20116 används i stället."),
        ("server-oss-not-support-tip", "OBS: GameDesk server OSS inkluderar inte denna funktion."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk kan inte nå skrivbordssessionen på fjärrenheten, kontrollera att en session körs och att GameDesk kan använda den"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk fick ingen användbar skärm från XDG Desktop Portal, PipeWire-biblioteket kan vara för gammalt"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk kunde inte läsa in en GStreamer-komponent som krävs för skärminspelning ({})"),
