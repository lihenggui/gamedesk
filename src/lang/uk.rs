...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі GameDesk..."),
        ...
        ("install_tip", "Через UAC, в деяких випадках GameDesk може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення GameDesk в системі"),
        ("Click to upgrade", "Натисніть, щоб перевірити наявність оновлень"),
        ("Configure", "Налаштувати"),
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати GameDesk дозволи \"Спеціальні можливості\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці, вам необхідно надати GameDesk дозволи на \"Запис екрана\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або дотику, вам необхідно дозволити GameDesk використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Будь ласка, перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [GameDesk Input]."),
        ...
        ("Language", "Мова"),
        ("Keep GameDesk background service", "Зберегти фонову службу GameDesk"),
        ...
        ("Show GameDesk", "Показати GameDesk"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати GameDesk дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати GameDesk дозвіл на \"Запис аудіо\""),
        ...
        ("verify_rustdesk_password_tip", "Перевірте пароль GameDesk"),
        ...
        ("scam_text1", "Якщо ви розмовляєте по телефону з кимось, кого НЕ ЗНАЄТЕ чи кому НЕ ДОВІРЯЄТЕ, і ця особа хоче, щоб ви використали GameDesk та запустили службу, не робіть цього та негайно завершіть дзвінок."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Будь ласка, оновіть GameDesk Server Pro до версії {} чи новіше!"),
        ...
        ("selinux_tip", "SELinux увімкнено на вашому пристрої, що може ускладнити для іншої сторони віддалене керування за допомогою GameDesk."),
        ...
        ("powered_by_me", "На основі GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Дозволяти підключення лише коли відкрите вікно GameDesk"),
        ...
        ("floating_window_tip", "Допомагає зберегти фонову службу GameDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Будь ласка, оновіть GameDesk клієнт на віддаленому пристрої до версії {} чи новіше!"),
        ...
        ("allow-insecure-tls-fallback-tip", "За замовчуванням GameDesk перевіряє сертифікат сервера для протоколів, які використовують TLS.\nКоли цей параметр увімкнено, у разі помилки перевірки GameDesk пропустить крок перевірки та продовжить."),
        ("Disable UDP", "Вимкнути UDP"),
        ("disable-udp-tip", "Визначає, чи використовувати лише TCP.\nКоли цей параметр увімкнено, GameDesk більше не використовуватиме UDP 20116, замість нього буде використано TCP 20116."),
        ("server-oss-not-support-tip", "ПРИМІТКА: сервер GameDesk OSS не містить цієї функції."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk не може отримати доступ до сеансу стільниці на віддаленому пристрої, перевірте, чи запущено сеанс і чи може GameDesk його використовувати"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk не зміг отримати придатний екран від XDG Desktop Portal, бібліотека PipeWire може бути застарою"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk не вдалося завантажити компонент GStreamer, потрібний для захоплення екрана ({})"),
