...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete GameDesk..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), GameDesk diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare GameDesk a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a GameDesk su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a GameDesk su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a GameDesk de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada GameDesk]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep GameDesk background service", "Mantene su servìtziu de GameDesk in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione GameDesk, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a GameDesk sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a GameDesk."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de GameDesk."),
        ...
        ("verify_rustdesk_password_tip", "Cunfirma sa crae de GameDesk"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare GameDesk e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualiza GameDesk Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de GameDesk comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana GameDesk est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de GameDesk"),
        ...
        ("About GameDesk", "Informatziones subra de GameDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualiza su cliente GameDesk remotu a sa versione {} o prus noa!"),
        ...
        ("allow-insecure-tls-fallback-tip", "De manera predefinida, GameDesk averguat su certificadu de su serbidore pro sos protocollos chi impreant TLS.\nCun custa optzione ativada, GameDesk at a brincare s'averguada e at a sighire in casu de faddina de averguada."),
        ("Disable UDP", "Disabìlita UDP"),
        ("disable-udp-tip", "Controllat si impreare petzi su TCP.\nCun custa optzione ativada, GameDesk no at a impreare prus sa UDP 20116, ma at a impreare sa TCP 20116."),
        ("server-oss-not-support-tip", "NOTA: su serbidore OSS de GameDesk non includet custa funtzione."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk no podet acèdere a sa sessione de iscrivania in su dispositivu remotu, controlla chi una sessione siat ativa e chi GameDesk la potzat impreare"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk no at pòdidu otènnere una schermada impreabile dae XDG Desktop Portal, sa libreria PipeWire podet èssere tropu betza"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk no at pòdidu carrigare unu cumponente de GStreamer netzessàriu pro registrare sa schermada ({})"),
