...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando á rede de GameDesk..."),
        ...
        ("install_tip", "Debido ao UAC, GameDesk non pode funcionar axeitadamente como lado remoto nalgúns casos. Para evitar o UAC, preme o botón de abaixo para instalar GameDesk no sistema."),
        ("Click to upgrade", "Preme para anovar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para poder controlar o teu escritorio remotamente, cómpre conceder a GameDesk permisos de «Accesibilidade»."),
        ("config_screen", "Para poder acceder ao teu escritorio remotamente, cómpre conceder a GameDesk permisos de «Gravación de pantalla»."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto poida controlar o teu dispositivo Android mediante rato ou táctil, cómpre permitirlle a GameDesk usar o servizo de «Accesibilidade»."),
        ("android_input_permission_tip2", "Por favor, vai á páxina de axustes do sistema seguinte, busca e entra en [Servizos instalados], e activa o servizo [Entrada de GameDesk]."),
        ...
        ("Language", "Idioma"),
        ("Keep GameDesk background service", "Manter o servizo de GameDesk en segundo plano"),
        ("Ignore Battery Optimizations", "Ignorar as optimizacións de batería"),
        ("android_open_battery_optimizations_tip", "Se queres desactivar esta función, vai á páxina seguinte de axustes do aplicativo GameDesk, busca e entra en [Batería] e desmarca [Sen restricións]"),
        ...
        ("config_input", "Para poder controlar o escritorio remoto co teclado, cómpre conceder a GameDesk permisos de «Monitorización de entrada»."),
        ("config_microphone", "Para poder falar remotamente, cómpre conceder a GameDesk permisos de «Gravar audio»."),
        ...
        ("still_click_uac_tip", "Aínda require que o usuario remoto prema Aceptar na ventá de UAC de GameDesk en execución."),
        ...
        ("verify_rustdesk_password_tip", "Verificar o contrasinal de GameDesk"),
        ...
        ("scam_text1", "Se estás ao teléfono con alguén que NON coñeces E no que NON confías que che pediu que uses GameDesk e inicies o servizo, non continúes e colga inmediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Por favor, anova GameDesk Server Pro á versión {} ou máis recente!"),
        ...
        ("selinux_tip", "SELinux está activado no teu dispositivo, o que podería impedir que GameDesk funcione axeitadamente como lado controlado."),
        ...
        ("powered_by_me", "Desenvolvido con GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Só permitir a conexión se a ventá de GameDesk está aberta"),
        ...
        ("floating_window_tip", "Axuda a manter o servizo de GameDesk en segundo plano"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Por favor, anova o cliente de GameDesk á versión {} ou máis recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "De maneira predeterminada, GameDesk verifica o certificado do servidor para os protocolos que usan TLS.\nCon esta opción activada, GameDesk omitirá o paso de verificación e continuará en caso de fallo de verificación."),
        ("Disable UDP", "Desactivar UDP"),
        ("disable-udp-tip", "Controla se usar só TCP.\nCando esta opción estea activada, GameDesk xa non usará o porto UDP 21116; no seu lugar usarase o porto TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: O servidor de código aberto (OSS) de GameDesk non inclúe esta funcionalidade."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk non pode acceder á sesión de escritorio do dispositivo remoto, comprobe que hai unha sesión en marcha e que GameDesk pode usala"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk non puido obter unha pantalla utilizable do XDG Desktop Portal, a biblioteca PipeWire pode ser demasiado antiga"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk non puido cargar un compoñente de GStreamer necesario para capturar a pantalla ({})"),
