...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, GameDesk bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, GameDesk'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ("Click to upgrade", "Yükseltmek için tıklayınız"),
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için GameDesk'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için GameDesk'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, GameDesk'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [GameDesk Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep GameDesk background service", "GameDesk arka plan hizmetini sürdürün"),
        ("Ignore Battery Optimizations", "Pil Optimizasyonlarını Yoksay"),
        ("android_open_battery_optimizations_tip", "Bu özelliği devre dışı bırakmak istiyorsanız lütfen bir sonraki GameDesk uygulama ayarları sayfasına gidin, [Pil] ögesini bulun ve girin, [Sınırsız] ögesinin işaretini kaldırın"),
        ...
        ("Show GameDesk", "GameDesk'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ("Elevate", "Yükseltme"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için GameDesk'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için GameDesk'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan GameDesk'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_rustdesk_password_tip", "GameDesk parolasını doğrulayın"),
        ...
        ("scam_text1", "Eğer tanımadığınız ve güvenmediğiniz birisiyle telefonda konuşuyorsanız ve sizden GameDesk'i kullanmanızı ve hizmeti başlatmanızı istiyorsa devam etmeyin ve hemen telefonu kapatın."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Lütfen GameDesk Server Pro'yu {} veya daha yeni bir sürüme yükseltin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux etkin olduğundan, GameDesk'in kontrollü tarafta düzgün çalışmasını engelleyebilir."),
        ...
        ("powered_by_me", "GameDesk tarafından desteklenmektedir"),
        ...
        ("allow-only-conn-window-open-tip", "Yalnızca GameDesk penceresi açıksa bağlantıya izin ver"),
        ...
        ("floating_window_tip", "GameDesk arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("About GameDesk", "GameDesk Hakkında"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Lütfen uzak tarafta GameDesk istemcisini {} sürümüne veya daha yenisine güncelleyin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Varsayılan olarak, GameDesk sunucu sertifikasını TLS kullanarak protokoller için doğrular.\nBu seçenek etkinleştirildiğinde, doğrulama başarısızlığı durumunda GameDesk doğrulama adımını atlayarak işleme devam eder."),
        ("Disable UDP", "UDP'yi devre dışı bırak"),
        ("disable-udp-tip", "Yalnızca TCP kullanılıp kullanılmayacağını kontrol eder.\nBu seçenek etkinleştirildiğinde, GameDesk artık UDP 20116'yı kullanmayacak, bunun yerine TCP 20116 kullanılacaktır."),
        ("server-oss-not-support-tip", "NOT: GameDesk sunucu OSS'si bu özelliği içermemektedir."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk uzak cihazdaki masaüstü oturumuna erişemiyor, bir masaüstü oturumunun çalıştığını ve GameDesk tarafından kullanılabildiğini doğrulayın"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk, XDG Desktop Portal'dan kullanılabilir bir ekran alamadı, PipeWire kitaplığı çok eski olabilir"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk ekran yakalama için gereken GStreamer bileşenini yükleyemedi ({})"),
