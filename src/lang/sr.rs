...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Zbog UAC GameDesk ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate GameDesk na sistem."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfigurisanje"),
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, GameDesk-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, GameDesk-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite GameDesk-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [GameDesk Input] servis."),
        ...
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje GameDesk aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ...
        ("Show GameDesk", "Prikazi GameDesk"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
        ("Elevate", "Izdigni"),
        ...
        ("config_input", "Da biste upravljali udaljenom radnom površinom tastaturom, potrebno je da dodelite GameDesk-u dozvolu \"Praćenje unosa\"."),
        ("config_microphone", "Da biste govorili na daljinu, potrebno je da dodelite GameDesk-u dozvolu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "I dalje zahteva da udaljeni korisnik klikne OK na UAC prozoru pokrenutog GameDesk-a."),
        ...
        ("verify_rustdesk_password_tip", "Potvrdi GameDesk lozinku"),
        ...
        ("scam_text1", "Ako razgovarate telefonom sa nekim koga NE poznajete I kome NE VERUJETE, a ko vas je zamolio da koristite GameDesk i pokrenete servis, nemojte nastaviti i odmah prekinite vezu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Molimo nadogradite GameDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "SELinux je omogućen na vašem uređaju, što može sprečiti GameDesk da radi pravilno kao kontrolisana strana."),
        ...
        ("allow-only-conn-window-open-tip", "Dozvoli konekciju samo ako je GameDesk prozor otvoren"),
        ...
        ("floating_window_tip", "Pomaže da se GameDesk pozadinski servis održi"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo nadogradite GameDesk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Podrazumevano, GameDesk proverava sertifikat servera za protokole koji koriste TLS.\nSa omogućenom ovom opcijom, GameDesk će preskočiti korak provere i nastaviti u slučaju neuspele provere."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Kontroliše da li se koristi samo TCP.\nKada je ova opcija omogućena, GameDesk više neće koristiti UDP 20116, umesto toga će se koristiti TCP 20116."),
        ("server-oss-not-support-tip", "NAPOMENA: GameDesk server OSS ne uključuje ovu funkciju."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk ne može da pristupi sesiji radne površine na udaljenom uređaju, proverite da li sesija radi i da li GameDesk može da je koristi"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk nije mogao da dobije upotrebljiv ekran od XDG Desktop Portala, PipeWire biblioteka je možda prestara"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk nije mogao da učita GStreamer komponentu potrebnu za snimanje ekrana ({})"),
