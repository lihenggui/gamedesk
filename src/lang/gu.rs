...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "કૃપા કરીને સેટિંગ્સમાં GameDesk શોધો અને તેને ચાલુ કરો."),
        ...
        ("Language", "ભાષા"),
        ("Keep GameDesk background service", "GameDesk બેકગ્રાઉન્ડ સેવા ચાલુ રાખો"),
        ...
        ("View Mode", "વ્યુ મોડ"),
        ("verify_rustdesk_password_tip", "GameDesk પાસવર્ડ ચકાસો"),
        ...
        ("scam_text1", "જો તમે અજાણી વ્યક્તિ સાથે વાત કરી રહ્યા હો અને તેણે GameDesk વાપરવા કહ્યું હોય, તો તરત ડિસ્કનેક્ટ કરો."),
        ...
        ("allow-only-conn-window-open-tip", "માત્ર GameDesk વિન્ડો ખુલ્લી હોય ત્યારે જ કનેક્શનની મંજૂરી આપો"),
        ...
        ("floating_window_tip", "બેકગ્રાઉન્ડમાં હોય ત્યારે GameDesk બતાવો"),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk રિમોટ ઉપકરણના ડેસ્કટોપ સત્ર સુધી પહોંચી શકતું નથી, ખાતરી કરો કે ડેસ્કટોપ સત્ર ચાલુ છે અને GameDesk તેનો ઉપયોગ કરી શકે છે"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk XDG Desktop Portal પાસેથી ઉપયોગી સ્ક્રીન મેળવી શક્યું નથી, PipeWire લાઇબ્રેરી કદાચ ઘણી જૂની છે"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk સ્ક્રીન કૅપ્ચર માટે જરૂરી GStreamer ઘટક લોડ કરી શક્યું નથી ({})"),
