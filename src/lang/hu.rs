...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("disable-udp-tip", "Meghatározza, hogy csak TCP-t használjon-e. Ha ez az beállítás engedélyezve van, a RustDesk nem fogja többé használni a 20116-os UDP-portot, helyette a 20116-os TCP-portot fogja használni."),
