...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Për shkak të UAC, GameDesk nuk mund të punoj sic duhet si nje remote në distancë në disa raste. Për të shamngur UAC, ju lutem klikoni butonin më poshtë për të instaluar GameDesk në sistem."),
        ("Click to upgrade", "Klikoni për përmirësim"),
        ("Configure", "Koniguro"),
        ("config_acc", "Për të kontrolluar Desktopin tuaj nga distanca, duhet të jepni leje GameDesk \"Aksesueshmëri\"."),
        ("config_screen", "Për të aksesuar Desktopin tuaj nga distanca, duhet ti jepni lejet GameDesk \"Regjistrimin e ekranit\"."),
        ...
        ("android_input_permission_tip1", "Në mënyrë që një pajisje në distancë të kontrollojë pajisjen tuaj Android nëpërmjet mausit ose prekjes, duhet të lejoni GameDesk të përdorë shërbimin."),
        ("android_input_permission_tip2", "Ju lutemi shkoni në faqen tjetër të cilësimeve të sistemit, gjeni dhe shtypni [Shërbimet e Instaluara], aktivizoni shërbimin [GameDesk Input]"),
        ...
        ("Turned off", "I fikur"),
        ("Language", "Gjuha"),
        ("Keep GameDesk background service", "Mbaje shërbimin e sfondit të GameDesk"),
        ("Ignore Battery Optimizations", "Injoro optimizimet e baterisë"),
        ("android_open_battery_optimizations_tip", "Nëse dëshironi ta çaktivizoni këtë veçori, ju lutemi shkoni te faqja tjetër e cilësimeve të aplikacionit GameDesk, gjeni dhe shtypni [Batteri], hiqni zgjedhjen [Te pakufizuara]"),
        ...
        ("config_input", "Për të kontrolluar desktopin në distancë me tastierë, duhet t'i jepni GameDesk lejen \"Monitorimi i hyrjes\"."),
        ("config_microphone", "Për të folur në distancë, duhet t'i jepni GameDesk lejen \"Regjistro audio\"."),
        ...
        ("still_click_uac_tip", "Ende kërkon që përdoruesi në distancë të klikojë OK në dritaren UAC të GameDesk që po funksionon."),
        ...
        ("verify_rustdesk_password_tip", "Verifiko fjalëkalimin e GameDesk"),
        ...
        ("scam_text1", "Nëse jeni në telefon me dikë që NUK e njihni DHE NUK i BESONI, i cili ju ka kërkuar të përdorni GameDesk dhe të nisni shërbimin, mos vazhdoni dhe mbyllni telefonin menjëherë."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Ju lutemi përmirësoni GameDesk Server Pro në versionin {} ose më të ri!"),
        ...
        ("selinux_tip", "SELinux është i aktivizuar në pajisjen tuaj, gjë që mund të pengojë GameDesk të funksionojë siç duhet si anë e kontrolluar."),
        ...
        ("powered_by_me", "Mundësuar nga GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Lejo lidhjen vetëm nëse dritarja e GameDesk është e hapur"),
        ...
        ("floating_window_tip", "Ndihmon për të mbajtur shërbimin në sfond të GameDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Ju lutemi përmirësoni klientin GameDesk në versionin {} ose më të ri në anën në distancë!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Si parazgjedhje, GameDesk verifikon certifikatën e serverit për protokollet që përdorin TLS.\nMe këtë opsion të aktivizuar, GameDesk do të kthehet duke kapërcyer hapin e verifikimit dhe do të vazhdojë në rast dështimi të verifikimit."),
        ("Disable UDP", "Çaktivizo UDP"),
        ("disable-udp-tip", "Kontrollon nëse do të përdoret vetëm TCP.\nKur ky opsion është i aktivizuar, GameDesk nuk do ta përdorë më UDP 20116, në vend të tij do të përdoret TCP 20116."),
        ("server-oss-not-support-tip", "SHËNIM: GameDesk server OSS nuk e përfshin këtë veçori."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk nuk mund të arrijë sesionin e desktopit në pajisjen e largët, kontrolloni që një sesion desktopi po funksionon dhe që GameDesk mund ta përdorë"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk nuk mori një ekran të përdorshëm nga XDG Desktop Portal, biblioteka PipeWire mund të jetë shumë e vjetër"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk nuk mundi të ngarkojë një komponent të GStreamer të nevojshëm për regjistrimin e ekranit ({})"),
