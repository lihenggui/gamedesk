...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do GameDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o GameDesk não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o GameDesk no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao GameDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao GameDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o GameDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [GameDesk Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep GameDesk background service", "Manter o serviço GameDesk em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação GameDesk, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show GameDesk", "Mostrar GameDesk"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao GameDesk as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao GameDesk as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do GameDesk em execução."),
        ...
        ("verify_rustdesk_password_tip", "Verificar palavra-passe do GameDesk"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o GameDesk e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o GameDesk Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o GameDesk de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo GameDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do GameDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do GameDesk"),
        ...
        ("About GameDesk", "Sobre o GameDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente GameDesk para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o GameDesk verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o GameDesk recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o GameDesk deixa de usar a UDP 20116, sendo usada a TCP 20116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o GameDesk server OSS não inclui esta funcionalidade."),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "O GameDesk não consegue aceder à sessão de ambiente de trabalho no dispositivo remoto, verifique se existe uma sessão ativa e se o GameDesk a pode usar"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "O GameDesk não conseguiu obter um ecrã utilizável do XDG Desktop Portal, a biblioteca PipeWire pode ser demasiado antiga"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "O GameDesk não conseguiu carregar um componente do GStreamer necessário para capturar o ecrã ({})"),
