...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "اپنے ڈیسک ٹاپ کو دور سے کنٹرول کرنے کے لیے آپ کو GameDesk کو \"Accessibility\" کی اجازتیں دینا ہوں گی۔"),
        ("config_screen", "اپنے ڈیسک ٹاپ تک دور سے رسائی کے لیے آپ کو GameDesk کو \"Screen Recording\" کی اجازتیں دینا ہوں گی۔"),
        ...
        ("android_input_permission_tip1", "کسی دور دراز آلے کو ماؤس یا ٹچ کے ذریعے آپ کے Android آلے کو کنٹرول کرنے کے لیے آپ کو GameDesk کو \"Accessibility\" سروس استعمال کرنے کی اجازت دینا ہوگی۔"),
        ("android_input_permission_tip2", "براہِ کرم اگلے سسٹم سیٹنگز صفحے پر جائیں، [Installed Services] تلاش کر کے کھولیں اور [GameDesk Input] سروس آن کریں۔"),
        ...
        ("Language", "زبان"),
        ("Keep GameDesk background service", "GameDesk پس منظر کی خدمت کو برقرار رکھیں"),
        ("Ignore Battery Optimizations", "بیٹری کی اصلاحات کو نظر انداز کریں"),
        ("android_open_battery_optimizations_tip", "اگر آپ یہ خصوصیت بند کرنا چاہتے ہیں تو براہِ کرم اگلے GameDesk ایپلیکیشن سیٹنگز صفحے پر جائیں، [Battery] تلاش کر کے کھولیں اور [Unrestricted] کا نشان ہٹا دیں"),
        ...
        ("Show GameDesk", "GameDesk دکھائیں"),
        ("This PC", "یہ PC"),
        ("or", "یا"),
        ("Elevate", "علیٰ کریں"),
        ...
        ("config_microphone", "دور سے بات کرنے کے لیے آپ کو GameDesk کو \"Record Audio\" کی اجازتیں دینا ہوں گی۔"),
        ...
        ("still_click_uac_tip", "پھر بھی ضروری ہے کہ دور دراز صارف چل رہے GameDesk کی UAC ونڈو پر OK پر کلک کرے۔"),
        ...
        ("verify_rustdesk_password_tip", "GameDesk پاس ورڈ کی تصدیق کریں"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "براہِ کرم GameDesk Server Pro کو ورژن {} یا اس سے نئے پر اپ گریڈ کریں!"),
        ...
        ("selinux_tip", "آپ کے آلے پر SELinux فعال ہے، جو GameDesk کو بطور کنٹرول شدہ فریق درست طور پر چلنے سے روک سکتا ہے۔"),
        ...
        ("allow-only-conn-window-open-tip", "کنکشن کی اجازت صرف اس صورت میں دیں جب GameDesk ونڈو کھلی ہو"),
        ...
        ("floating_window_tip", "یہ GameDesk کی پس منظر سروس کو برقرار رکھنے میں مدد دیتا ہے"),
        ...
        ("About GameDesk", "رستڈیسک کے بارے میں"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "براہِ کرم دور دراز فریق پر GameDesk کلائنٹ کو ورژن {} یا اس سے نئے پر اپ گریڈ کریں!"),
        ...
        ("allow-insecure-tls-fallback-tip", "پہلے سے طے شدہ طور پر GameDesk TLS استعمال کرنے والے پروٹوکولز کے لیے سرور کے سرٹیفکیٹ کی تصدیق کرتا ہے۔\nیہ اختیار فعال ہونے پر، تصدیق ناکام ہونے کی صورت میں GameDesk تصدیق کا مرحلہ چھوڑ کر آگے بڑھ جائے گا۔"),
        ("Disable UDP", "UDP کو غیر فعال کریں"),
        ("disable-udp-tip", "طے کرتا ہے کہ صرف TCP استعمال کیا جائے یا نہیں۔\nیہ اختیار فعال ہونے پر GameDesk UDP 21116 مزید استعمال نہیں کرے گا، اس کی جگہ TCP 21116 استعمال ہوگا۔"),
        ("server-oss-not-support-tip", "نوٹ: GameDesk سرور OSS میں یہ خصوصیت شامل نہیں ہے۔"),
        ...
        ("GameDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that GameDesk can use it", "GameDesk ریموٹ ڈیوائس کے ڈیسک ٹاپ سیشن تک رسائی حاصل نہیں کر سکتا، تصدیق کریں کہ ڈیسک ٹاپ سیشن چل رہا ہے اور GameDesk اسے استعمال کر سکتا ہے"),
        ...
        ("GameDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "GameDesk کو XDG Desktop Portal سے قابلِ استعمال اسکرین نہیں مل سکی، PipeWire لائبریری شاید بہت پرانی ہے"),
        ("GameDesk could not load a GStreamer component needed for screen capture ({})", "GameDesk اسکرین ریکارڈنگ کے لیے درکار GStreamer جزو لوڈ نہیں کر سکا ({})"),
