...
class MainActivity : FlutterActivity() {
    ...
    override fun onDestroy() {
        ...
        // Close outgoing sessions when the UI really goes away, so a session
        // cannot outlive the UI that is able to close it. `isFinishing`
        // excludes destroys for recreation (configuration change).
        if (isFinishing) {
