...
import 'package:gamedesk/common/widgets/animated_rotation_widget.dart';
import 'package:gamedesk/common/widgets/custom_password.dart';
import 'package:gamedesk/consts.dart';
import 'package:gamedesk/desktop/pages/connection_page.dart';
...
import 'package:gamedesk/desktop/widgets/update_progress.dart';
...
class _DesktopHomePageState extends State<DesktopHomePage>
  ...
  Widget buildHelpCards(String updateUrl) {
    if (!bind.isCustomClient() &&
        ...
        !isCardClosed &&
        bind.mainUriPrefixSync().contains('gamedesk')) {
