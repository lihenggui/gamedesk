...
import 'package:gamedesk/common/widgets/audio_input.dart';
import 'package:gamedesk/common/widgets/setting_widgets.dart';
import 'package:gamedesk/consts.dart';
import 'package:gamedesk/desktop/pages/desktop_home_page.dart';
...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: translate('About GameDesk'), children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
